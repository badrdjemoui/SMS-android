        ...
        btnEnvoie.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(num.length()>= 4 && msg.length() > 0){
                    ...
                    Toast.makeText(EnvoieSms.this, "avant sendTextMessage", Toast.LENGTH_SHORT).show();
                    SmsManager.getDefault().sendTextMessage(num, null, msg, null, null);
                    //On efface les deux EditText
                    Toast.makeText(EnvoieSms.this, "apres sendTextMessage", Toast.LENGTH_SHORT).show();
                    numero.setText("");
                    message.setText("");
                }else{
